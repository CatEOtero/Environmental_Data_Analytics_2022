...
Only use rbind or cbind if you KNOW the rows and columns are the same in two datasets. If you're not sure than you use Join.

one line is outside aes
for each category gets a color put it in the aes
