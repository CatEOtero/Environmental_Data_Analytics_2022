...
```{r}
<<<<<<< HEAD
#below shows how to get the greek letter mu, and a comma and the R squared
=======
library(ggplot2)
>>>>>>> 72ec65b1e12c2534c82aa2ec6af3c9b999b7ca57
Plot_text <-
  #starts the grid at 0,0
ggplot(data=data.frame(x=0,y=0))+
  #makes the grid of the plot
  geom_point(aes(x=x,y=y)) +
  #adds text to the grid at the specified x,y location
...
temperatures_by_year <- 
  ggplot(PeterPaul.chem.nutrients, aes(x = sampledate, y = temperature_C, color = year4)) +
  geom_point(aes(color=depth), size = 0.5) +
  scale_color_viridis(option = "magma", direction = -1) +
  scale_x_date(date_breaks = "5 years", date_labels = "%Y") +
  ylab("Temperature in Celsius")
print(temperatures_by_year)
