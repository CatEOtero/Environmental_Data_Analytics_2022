...
#cowplot let's you transform your window into a matrix so can display multiple graphs together
library(cowplot)
...
```
color is the contour of the markers or line
fill is about filling in the color of boxplot etc