...
> Answer: ifelse works because it checks the whole vector and returns outputs for each row of data in the vector whilt if and else only outputed one answer.
