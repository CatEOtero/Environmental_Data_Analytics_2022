...
colnames(exam_results.df) <- c('Student Names','Test Scores','Passing Score?')
...
> Answer: ifelse works because you can put multiple arguments into it at one time. If and else you can only put one argument in at a time.
